  ...
  return (
    <section id="how" className="relative overflow-hidden py-20">
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <RevealOnScroll
          as="ol"
          className="relative mt-14 space-y-8 pl-6 before:absolute before:left-[1.45rem] before:top-4 before:h-[calc(100%-2rem)] before:w-px before:bg-gradient-to-b before:from-accent/40 before:via-accent/10 before:to-transparent sm:pl-8 md:pl-12"
        >
        ...
        <RevealOnScroll className="mt-10 grid gap-4 rounded-[2.2rem] border border-white/60 bg-white/85 p-6 text-sm text-dark/70 shadow-glow backdrop-blur-xl md:grid-cols-3">
