...
export default function Footer() {
  return (
    <footer className="mt-24 border-t border-white/50 bg-white/70 backdrop-blur-2xl">
      <div className="mx-auto max-w-6xl px-4 py-12 text-sm text-dark/70">
        ...
        <div className="mt-8 flex flex-col gap-4 text-xs text-dark/60 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-4 text-dark/70">
            ...
            <a href="https://t.me/dpvlen" aria-label="Telegram" className="transition hover:text-accent">
              <Send className="h-5 w-5" />
            </a>
          </div>
        </div>
        <p className="mt-6 text-xs text-dark/60">© 2025 Лизинг и точка</p>
      </div>
    </footer>
  )
}
