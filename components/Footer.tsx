      ...
      <div className="relative mx-auto max-w-6xl px-4 py-12 text-sm text-dark/70">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <nav className="grid gap-2 text-sm md:text-right">
            ...
            <a href="#examples" className="transition hover:text-accent">
              Примеры
            </a>
            <a href="#faq" className="transition hover:text-accent">
              FAQ
            </a>
            <a href="#contacts" className="transition hover:text-accent">
              Контакты
            </a>
        ...
        <div className="mt-8 flex flex-col gap-4 text-xs text-dark/60 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-4 text-dark/70">
            ...
            <a href="mailto:erevakshin@lizing-i-tochka.ru" aria-label="Написать" className="transition hover:text-accent">
