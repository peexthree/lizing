  ...
  return (
    ...
    >
      <div className="pointer-events-none relative flex h-full w-full items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-white via-[#e0ffff] to-[#00ced1] mix-blend-screen opacity-0 animate-splash-flash" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/70 to-transparent" />
        <Image
          priority
          alt="Лизинг и точка"
          className="relative z-10 w-[min(84vw,720px)] max-w-none animate-splash-logo drop-shadow-[0_40px_120px_rgba(0,206,209,0.45)]"
          height={720}
          src="/logo_big.webp"
          width={720}
        />
