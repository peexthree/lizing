...
const faqData = [
    {
        ...
        answer: 'Вы можете приобрести в лизинг практически всё, что нужно для вашего бизнеса: легковые авто, грузовики, спецтехнику (тракторы, экскаваторы), промышленное оборудование, коммерческую и жилую недвижимость, апартаменты и даже ЖД вагоны.'
    },
    {
    ...
    },
    {
        ...
        answer: 'Договор лизинга заключается на срок от 6 месяцев до 10 лет. Мы поможем вам выбрать оптимальный срок и график платежей, чтобы они соответствовали окупаемости вашего имущества.'
    },
    {
        question: 'Как быстро я смогу получить технику?',
        answer: 'Обычно срок получения техники составляет\nот 3 до 7 рабочих дней с момента предоставления вами полного пакета необходимых документов и одобрения вашей заявки Лизингодателем. Указанный срок включает подписание договора лизинга и передачу вам техники по акту приема-передачи.'
    },
    {
