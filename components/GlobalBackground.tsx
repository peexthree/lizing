...
/**
 * Renders the animated Balatro shader as the global site background layer.
 * Static gradient overlays remain on top to preserve the brand palette and
 * guarantee a graceful fallback if WebGL is unavailable.
 */
const GlobalBackground = () => {
  return (
    <div className="pointer-events-none fixed inset-0 -z-50 overflow-hidden" aria-hidden>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#050506] via-[#09090f] to-[#06060a]" />
