                ...
                <div className="flex h-20 items-center justify-between">
                    ...
                    <nav className="hidden md:block">
                        <ul className="flex items-center space-x-8">
                            {navLinks.map(link => (
                                <li key={link.href}>
                                    <a href={link.href} className="font-medium text-muted hover:text-text transition-colors">
                                        {link.label}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div className="hidden md:block">
                        <a href="#lead-form" className="inline-flex items-center justify-center px-5 py-2.5 border border-transparent text-base font-medium rounded-full text-white bg-accent hover:bg-accent/90 transition-colors">
                            Оставить заявку
                        </a>
                    </div>
                            ...
                            <div className="px-5 pt-5 pb-6">
                                ...
                                <div className="mt-6">
                                    <nav className="grid gap-y-8">
                                        {navLinks.map(link => (
                                            <a key={link.href} href={link.href} onClick={() => setIsOpen(false)} className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                             ...
                             <div className="py-6 px-5 space-y-6">
                                <a href="#lead-form" onClick={() => setIsOpen(false)} className="block w-full px-5 py-3 text-center font-medium text-white bg-accent rounded-md hover:bg-accent/90">
                                    Оставить заявку
                                </a>
                            </div>
                        </div>
